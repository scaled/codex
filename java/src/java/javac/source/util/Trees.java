...
import javac.source.tree.ClassTree;
import javac.source.tree.CompilationUnitTree;
import javac.source.tree.MethodTree;
...
public abstract class Trees {
    ...
    public static Trees instance(CompilationTask task) {
        ...
        if (!taskClassName.equals("javac.tools.javac.api.JavacTaskImpl")
                && !taskClassName.equals("javac.tools.javac.api.BasicJavacTask"))
    ...
    public static Trees instance(ProcessingEnvironment env) {
        if (!env.getClass().getName().equals("javac.tools.javac.processing.JavacProcessingEnvironment"))
            throw new IllegalArgumentException();
    ...
    static Trees getJavacTrees(Class<?> argType, Object arg) {
        try {
            ...
            Class<?> c = Class.forName("javac.tools.javac.api.JavacTrees", false, cl);
