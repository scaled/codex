...
package javac.tools.sjavac.options;
...
import javac.tools.sjavac.CopyFile;
 ...
 * option values, refer to javac.tools.sjavac.options.Options.
 *
...
public enum Option {
    ...
    TR("-tr", "Translate resources") {
        ...
        protected void processMatching(ArgumentIterator iter, OptionHelper helper) {
            ...
            //   .prop=javac.tools.javac.smart.CompileProperties
            //   .idl=javac.corba.CompileIdl
