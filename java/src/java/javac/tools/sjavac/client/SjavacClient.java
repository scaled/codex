...
package javac.tools.sjavac.client;
...
import javac.tools.sjavac.options.OptionHelper;
import javac.tools.sjavac.options.Options;
import javac.tools.sjavac.server.CompilationSubResult;
import javac.tools.sjavac.server.PortFile;
import javac.tools.sjavac.server.Sjavac;
import javac.tools.sjavac.server.SjavacServer;
...
public class SjavacClient implements Sjavac {
    ...
    // to point to a javac.tools.sjavac.Main that supports --startserver
    // for example by setting: sjavac=java%20-jar%20...javac.jar%javac.tools.sjavac.Main
