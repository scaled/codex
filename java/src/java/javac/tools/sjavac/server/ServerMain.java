...
package javac.tools.sjavac.server;
...
import javac.tools.sjavac.Log.Level;
import javac.tools.sjavac.server.log.LazyInitFileLog;
import javac.tools.sjavac.server.log.LoggingOutputStream;

import static javac.tools.sjavac.Log.Level.ERROR;
import static javac.tools.sjavac.Log.Level.INFO;
