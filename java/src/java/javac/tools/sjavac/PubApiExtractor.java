...
import javac.tools.sjavac.comp.PubapiVisitor;
import javac.tools.sjavac.comp.SmartFileManager;
...
public class PubApiExtractor {
    ...
    public PubApiExtractor(Options options) {
        JavacTool compiler = javac.tools.javac.api.JavacTool.create();
        fileManager = new SmartFileManager(compiler.getStandardFileManager(null, null, null));
        context = new javac.tools.javac.util.Context();
