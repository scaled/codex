...
import javac.tools.javac.util.Dependencies;
import javac.tools.javac.util.ListBuffer;
import javac.tools.sjavac.Log;
import javac.tools.sjavac.Util;
import javac.tools.sjavac.comp.dependencies.NewDependencyCollector;
import javac.tools.sjavac.comp.dependencies.PublicApiCollector;
import javac.tools.sjavac.server.CompilationSubResult;
import javac.tools.sjavac.server.SysInfo;
                ...
                if (explicitJFOs.size() > 0) {
                    ...
                    JavacTaskImpl task =
                            (JavacTaskImpl) compiler.getTask(new PrintWriter(stderrLog),
                                                             ...
                                                             explicitJFOs,
                                                             context);
                    sfm.setSymbolFileEnabled(!javac.tools.javac.util.Options.instance(context).isSet("ignore.symbol.file"));
