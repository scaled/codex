...
*/
// Code duplicated in javac.tools.classfile.TypeAnnotation.Position
public class TypeAnnotationPosition {
    ...
    // javac.tools.javac.jvm.Gen.genCatch, we first use this to hold
    // the catch type's constant pool entry index.  Then in
    // javac.tools.javac.jvm.Code.fillExceptionParameterPositions we
