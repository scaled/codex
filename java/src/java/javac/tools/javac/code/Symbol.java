...
import javac.tools.javac.code.ClassFinder.BadEnclosingMethodAttr;
import javac.tools.javac.code.Directive.RequiresFlag;
import javac.tools.javac.code.Kinds.Kind;
import javac.tools.javac.comp.Annotate.AnnotationTypeMetadata;
...
import javac.tools.javac.tree.JCTree.JCFieldAccess;
...
import static javac.tools.javac.code.Scope.LookupKind.NON_RECURSIVE;
import static javac.tools.javac.code.Symbol.OperatorSymbol.AccessCode.FIRSTASGOP;
import static javac.tools.javac.code.TypeTag.CLASS;
import static javac.tools.javac.code.TypeTag.FORALL;
import static javac.tools.javac.code.TypeTag.TYPEVAR;
import static javac.tools.javac.jvm.ByteCodes.iadd;
import static javac.tools.javac.jvm.ByteCodes.ishll;
import static javac.tools.javac.jvm.ByteCodes.lushrl;
import static javac.tools.javac.jvm.ByteCodes.lxor;
import static javac.tools.javac.jvm.ByteCodes.string_add;
...
public abstract class Symbol extends AnnoConstruct implements Element {
    ...
    public static class ModuleSymbol extends TypeSymbol
        ...
        public List<javac.tools.javac.code.Directive> directives;
        public List<javac.tools.javac.code.Directive.RequiresDirective> requires;
        public List<javac.tools.javac.code.Directive.ExportsDirective> exports;
        public List<javac.tools.javac.code.Directive.OpensDirective> opens;
        public List<javac.tools.javac.code.Directive.ProvidesDirective> provides;
        public List<javac.tools.javac.code.Directive.UsesDirective> uses;
