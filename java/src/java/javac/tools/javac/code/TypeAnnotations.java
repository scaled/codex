...
package javac.tools.javac.code;
...
import javac.tools.javac.code.Attribute.Array;
import javac.tools.javac.code.Attribute.TypeCompound;
...
import javac.tools.javac.code.Type.CapturedType;
import javac.tools.javac.code.Type.ClassType;
import javac.tools.javac.code.Type.ErrorType;
import javac.tools.javac.code.Type.ForAll;
import javac.tools.javac.code.Type.MethodType;
import javac.tools.javac.code.Type.PackageType;
import javac.tools.javac.code.Type.TypeVar;
import javac.tools.javac.code.Type.UndetVar;
import javac.tools.javac.code.Type.Visitor;
import javac.tools.javac.code.Type.WildcardType;
import javac.tools.javac.code.TypeAnnotationPosition.TypePathEntry;
import javac.tools.javac.code.TypeAnnotationPosition.TypePathEntryKind;
import javac.tools.javac.code.Symbol.VarSymbol;
import javac.tools.javac.code.Symbol.MethodSymbol;
import javac.tools.javac.code.Type.ModuleType;
import javac.tools.javac.code.TypeMetadata.Entry.Kind;
import javac.tools.javac.comp.Annotate;
...
import javac.tools.javac.tree.JCTree.JCLambda;
import javac.tools.javac.tree.JCTree.JCMethodDecl;
import javac.tools.javac.tree.JCTree.JCMethodInvocation;
import javac.tools.javac.tree.JCTree.JCNewClass;
import javac.tools.javac.tree.JCTree.JCTypeApply;
import javac.tools.javac.tree.JCTree.JCVariableDecl;
import javac.tools.javac.tree.TreeScanner;
import javac.tools.javac.tree.JCTree.*;
...
public class TypeAnnotations {
    ...
    private class TypeAnnotationPositions extends TreeScanner {
        ...
        // {@link javac.tools.javac.parser.JavacParser.insertAnnotationsToMostInner(JCExpression, List<JCTypeAnnotation>, boolean)}
                ...
                final TypeAnnotationPosition pos)
        {
            ...
            if (type.hasTag(TypeTag.TYPEVAR)) {
                ...
                // UnionClassType uct = (javac.tools.javac.code.Type.UnionClassType)type;
                         ...
                         ListBuffer<TypePathEntry> location)
        {
            ...
            // javac.tools.javac.jvm.Gen.setTypeAnnotationPositions(int)
