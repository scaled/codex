...
import javac.tools.javac.code.Type.BottomType;
import javac.tools.javac.code.Type.ClassType;
import javac.tools.javac.code.Type.ErrorType;
import javac.tools.javac.code.Type.JCPrimitiveType;
import javac.tools.javac.code.Type.JCVoidType;
import javac.tools.javac.code.Type.MethodType;
import javac.tools.javac.code.Type.UnknownType;
        ...
        unnamedModule = new ModuleSymbol(names.empty, null) {
                {
                    ...
                    javac.tools.javac.code.Directive.RequiresDirective d =
                            new javac.tools.javac.code.Directive.RequiresDirective(java_base,
                                    EnumSet.of(javac.tools.javac.code.Directive.RequiresFlag.MANDATED));
                    requires = List.of(d);
                }
                @Override
