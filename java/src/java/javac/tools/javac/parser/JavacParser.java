...
package javac.tools.javac.parser;
...
import javac.tools.javac.parser.Tokens.*;
import javac.tools.javac.parser.Tokens.Comment.CommentStyle;
import javac.tools.javac.resources.CompilerProperties;
...
import static javac.tools.javac.parser.Tokens.TokenKind.*;
import static javac.tools.javac.parser.Tokens.TokenKind.ASSERT;
import static javac.tools.javac.parser.Tokens.TokenKind.CASE;
import static javac.tools.javac.parser.Tokens.TokenKind.CATCH;
import static javac.tools.javac.parser.Tokens.TokenKind.EQ;
import static javac.tools.javac.parser.Tokens.TokenKind.GT;
import static javac.tools.javac.parser.Tokens.TokenKind.IMPORT;
import static javac.tools.javac.parser.Tokens.TokenKind.LT;
        ...
        if (token.kind == LBRACKET || token.kind == MONKEYS_AT) {
            ...
            if (newClass.def != null) {
                ...
                if (newAnnotations.nonEmpty()) {
                    ...
                    // javac.tools.javac.code.TypeAnnotations.TypeAnnotationPositions.visitNewClass(JCNewClass)
