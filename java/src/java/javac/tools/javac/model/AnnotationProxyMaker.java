...
public class AnnotationProxyMaker {
    ...
    private static abstract class ExceptionProxy {
    ...
    private Annotation generateAnnotation() {
        return null; // AnnotationParser.annotationForMap(annoType, getAllReflectedValues());
    }
        ...
        public void visitEnum(Attribute.Enum e) {
            if (returnClass.isEnum()) {
                ...
                try {
                    ...
                    value = null; // new EnumConstantNotPresentExceptionProxy(
