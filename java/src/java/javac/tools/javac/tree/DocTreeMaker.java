...
package javac.tools.javac.tree;
...
import javac.source.doctree.DocTree.Kind;
...
import javac.source.util.DocTreeFactory;
import javac.tools.doclint.HtmlTag;
import javac.tools.javac.api.JavacTrees;
import javac.tools.javac.parser.ParserFactory;
import javac.tools.javac.parser.ReferenceParser;
import javac.tools.javac.parser.Tokens.Comment;
import javac.tools.javac.parser.Tokens.Comment.CommentStyle;
import javac.tools.javac.tree.DCTree.DCAttribute;
import javac.tools.javac.tree.DCTree.DCAuthor;
import javac.tools.javac.tree.DCTree.DCComment;
import javac.tools.javac.tree.DCTree.DCDeprecated;
import javac.tools.javac.tree.DCTree.DCDocComment;
import javac.tools.javac.tree.DCTree.DCDocRoot;
import javac.tools.javac.tree.DCTree.DCEndElement;
import javac.tools.javac.tree.DCTree.DCEntity;
import javac.tools.javac.tree.DCTree.DCErroneous;
import javac.tools.javac.tree.DCTree.DCHidden;
import javac.tools.javac.tree.DCTree.DCIdentifier;
import javac.tools.javac.tree.DCTree.DCIndex;
import javac.tools.javac.tree.DCTree.DCInheritDoc;
import javac.tools.javac.tree.DCTree.DCLink;
import javac.tools.javac.tree.DCTree.DCLiteral;
import javac.tools.javac.tree.DCTree.DCParam;
import javac.tools.javac.tree.DCTree.DCProvides;
import javac.tools.javac.tree.DCTree.DCReference;
import javac.tools.javac.tree.DCTree.DCReturn;
import javac.tools.javac.tree.DCTree.DCSee;
import javac.tools.javac.tree.DCTree.DCSerial;
import javac.tools.javac.tree.DCTree.DCSerialData;
import javac.tools.javac.tree.DCTree.DCSerialField;
import javac.tools.javac.tree.DCTree.DCSince;
import javac.tools.javac.tree.DCTree.DCStartElement;
import javac.tools.javac.tree.DCTree.DCText;
import javac.tools.javac.tree.DCTree.DCThrows;
import javac.tools.javac.tree.DCTree.DCUnknownBlockTag;
import javac.tools.javac.tree.DCTree.DCUnknownInlineTag;
import javac.tools.javac.tree.DCTree.DCUses;
import javac.tools.javac.tree.DCTree.DCValue;
import javac.tools.javac.tree.DCTree.DCVersion;
...
import static javac.tools.doclint.HtmlTag.*;
