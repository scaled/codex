...
package javac.tools.javac.util;
...
import javac.tools.javac.api.DiagnosticFormatter;
import javac.tools.javac.api.DiagnosticFormatter.Configuration.DiagnosticPart;
import javac.tools.javac.api.DiagnosticFormatter.Configuration.MultilineLimit;
import javac.tools.javac.api.DiagnosticFormatter.PositionKind;
import javac.tools.javac.api.Formattable;
import javac.tools.javac.code.Lint.LintCategory;
import javac.tools.javac.code.Printer;
...
import javac.tools.javac.tree.Pretty;

import static javac.tools.javac.util.JCDiagnostic.DiagnosticType.*;
