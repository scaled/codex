...
import javac.tools.javac.util.AbstractDiagnosticFormatter.SimpleConfiguration;
import javac.tools.javac.util.BasicDiagnosticFormatter.BasicConfiguration;

import static javac.tools.javac.api.DiagnosticFormatter.PositionKind.*;
import static javac.tools.javac.util.BasicDiagnosticFormatter.BasicConfiguration.*;
