...
package javac.tools.javac.processing;
...
import javac.tools.javac.api.MultiTaskListener;
...
import javac.tools.javac.comp.Check;
import javac.tools.javac.comp.Enter;
import javac.tools.javac.comp.Env;
import javac.tools.javac.comp.Modules;
import javac.tools.javac.file.JavacFileManager;
import javac.tools.javac.main.JavaCompiler;
import javac.tools.javac.main.Option;
import javac.tools.javac.model.JavacElements;
import javac.tools.javac.model.JavacTypes;
import javac.tools.javac.platform.PlatformDescription;
import javac.tools.javac.platform.PlatformDescription.PluginInfo;
...
import javac.tools.javac.util.ClientCodeException;
import javac.tools.javac.util.Context;
import javac.tools.javac.util.Convert;
import javac.tools.javac.util.DefinedBy;
import javac.tools.javac.util.DefinedBy.Api;
import javac.tools.javac.util.Iterators;
import javac.tools.javac.util.JCDiagnostic;
import javac.tools.javac.util.JDK9Wrappers.Module;
import javac.tools.javac.util.JavacMessages;
import javac.tools.javac.util.List;
import javac.tools.javac.util.Log;
import javac.tools.javac.util.MatchingUtils;
import javac.tools.javac.util.ModuleHelper;
import javac.tools.javac.util.Name;
import javac.tools.javac.util.Names;
import javac.tools.javac.util.Options;

import static javac.tools.javac.code.Lint.LintCategory.PROCESSING;
import static javac.tools.javac.code.Kinds.Kind.*;
import javac.tools.javac.comp.Annotate;
import static javac.tools.javac.comp.CompileStates.CompileState;
import static javac.tools.javac.util.JCDiagnostic.DiagnosticFlag.*;
