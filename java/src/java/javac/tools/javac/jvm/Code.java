...
import static javac.tools.javac.code.TypeTag.INT;
import static javac.tools.javac.jvm.ByteCodes.*;
import static javac.tools.javac.jvm.UninitializedType.*;
import static javac.tools.javac.jvm.ClassWriter.StackMapTableFrame;
