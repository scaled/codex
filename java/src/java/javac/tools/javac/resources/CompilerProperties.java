...
import javac.tools.javac.code.Kinds.KindName;
...
import javac.tools.javac.util.JCDiagnostic.Error;
import javac.tools.javac.util.JCDiagnostic.Warning;
import javac.tools.javac.util.JCDiagnostic.Note;
