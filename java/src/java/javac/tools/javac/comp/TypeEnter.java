...
import javac.tools.javac.code.Scope.ImportFilter;
...
import static javac.tools.javac.code.TypeTag.ERROR;
import static javac.tools.javac.tree.JCTree.Tag.*;

import javac.tools.javac.util.Dependencies.CompletionCause;
