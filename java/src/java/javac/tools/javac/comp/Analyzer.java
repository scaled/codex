...
import javac.source.tree.LambdaExpressionTree;
...
import javac.tools.javac.tree.JCTree.JCDoWhileLoop;
import javac.tools.javac.tree.JCTree.JCEnhancedForLoop;
import javac.tools.javac.tree.JCTree.JCForLoop;
import javac.tools.javac.tree.JCTree.JCIf;
import javac.tools.javac.tree.JCTree.JCLambda;
import javac.tools.javac.tree.JCTree.JCLambda.ParameterKind;
...
import javac.tools.javac.tree.JCTree.JCStatement;
import javac.tools.javac.tree.JCTree.JCSwitch;
import javac.tools.javac.tree.JCTree.JCTypeApply;
import javac.tools.javac.tree.JCTree.JCVariableDecl;
import javac.tools.javac.tree.JCTree.JCWhileLoop;
...
import static javac.tools.javac.code.Flags.GENERATEDCONSTR;
import static javac.tools.javac.code.Flags.SYNTHETIC;
import static javac.tools.javac.code.TypeTag.CLASS;
import static javac.tools.javac.tree.JCTree.Tag.APPLY;
import static javac.tools.javac.tree.JCTree.Tag.METHODDEF;
import static javac.tools.javac.tree.JCTree.Tag.NEWCLASS;
import static javac.tools.javac.tree.JCTree.Tag.TYPEAPPLY;
...
public class Analyzer {
    ...
    /**
     * Subclass of {@link javac.tools.javac.tree.TreeScanner} which visit AST-nodes w/o crossing
