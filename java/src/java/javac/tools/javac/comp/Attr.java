...
import javac.source.tree.IdentifierTree;
import javac.source.tree.MemberReferenceTree.ReferenceMode;
import javac.source.tree.MemberSelectTree;
import javac.source.tree.TreeVisitor;
import javac.source.util.SimpleTreeVisitor;
import javac.tools.javac.code.*;
...
import javac.tools.javac.code.TypeMetadata.Annotations;
import javac.tools.javac.code.Types.FunctionDescriptorLookupError;
import javac.tools.javac.comp.ArgumentAttr.LocalCacheContext;
import javac.tools.javac.comp.Check.CheckContext;
import javac.tools.javac.comp.DeferredAttr.AttrMode;
import javac.tools.javac.comp.Infer.FreeTypeListener;
import javac.tools.javac.jvm.*;
import static javac.tools.javac.resources.CompilerProperties.Fragments.Diamond;
import static javac.tools.javac.resources.CompilerProperties.Fragments.DiamondInvalidArg;
import static javac.tools.javac.resources.CompilerProperties.Fragments.DiamondInvalidArgs;
import javac.tools.javac.resources.CompilerProperties.Errors;
import javac.tools.javac.resources.CompilerProperties.Fragments;
import javac.tools.javac.tree.*;
import javac.tools.javac.tree.JCTree.*;
import javac.tools.javac.tree.JCTree.JCPolyExpression.*;
import javac.tools.javac.util.*;
import javac.tools.javac.util.DefinedBy.Api;
import javac.tools.javac.util.JCDiagnostic.DiagnosticPosition;
import javac.tools.javac.util.JCDiagnostic.Fragment;
import javac.tools.javac.util.List;

import static javac.tools.javac.code.Flags.*;
import static javac.tools.javac.code.Flags.ANNOTATION;
import static javac.tools.javac.code.Flags.BLOCK;
import static javac.tools.javac.code.Kinds.*;
import static javac.tools.javac.code.Kinds.Kind.*;
import static javac.tools.javac.code.TypeTag.*;
import static javac.tools.javac.code.TypeTag.WILDCARD;
import static javac.tools.javac.tree.JCTree.Tag.*;
 ...
 *************************************************************************/
    ...
    private final class TypeAnnotationsValidator extends TreeScanner {
         ...
         * javac.tools.javac.comp.Check.Validator.visitSelectInternal(JCFieldAccess)
