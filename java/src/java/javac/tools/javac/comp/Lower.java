...
import javac.tools.javac.code.Kinds.KindSelector;
import javac.tools.javac.code.Scope.WriteableScope;
import javac.tools.javac.jvm.*;
import javac.tools.javac.main.Option.PkgInfo;
...
import javac.tools.javac.code.Symbol.OperatorSymbol.AccessCode;
import javac.tools.javac.tree.JCTree.*;
import javac.tools.javac.code.Type.*;

import javac.tools.javac.jvm.Target;
...
import static javac.tools.javac.code.Symbol.OperatorSymbol.AccessCode.DEREF;
import static javac.tools.javac.jvm.ByteCodes.*;
import static javac.tools.javac.tree.JCTree.JCOperatorExpression.OperandPos.LEFT;
