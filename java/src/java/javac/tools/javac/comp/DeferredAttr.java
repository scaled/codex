...
import javac.source.tree.NewClassTree;
import javac.tools.javac.code.*;
import javac.tools.javac.code.Type.StructuralTypeMapping;
import javac.tools.javac.code.Types.TypeMapping;
import javac.tools.javac.comp.ArgumentAttr.LocalCacheContext;
import javac.tools.javac.comp.Resolve.ResolveError;
...
import javac.tools.javac.util.GraphUtils.DependencyKind;
...
import javac.tools.javac.util.Log.DeferredDiagnosticHandler;
...
import javac.source.tree.MemberReferenceTree;
import javac.tools.javac.tree.JCTree.JCMemberReference.OverloadKind;
...
public class DeferredAttr extends JCTree.Visitor {
     ...
     */
    abstract static class FilterScanner extends javac.tools.javac.tree.TreeScanner {
