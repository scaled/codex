...
import javac.tools.javac.main.CommandLine;
...
public class JavahTask implements NativeHeaderTool.NativeHeaderTask {
    ...
    private static final String versionRBName = "javac.tools.javah.resources.version";
    ...
    private String getMessage(Locale locale, String key, Object... args) {
        ...
        if (b == null) {
            try {
                b = ResourceBundle.getBundle("javac.tools.javah.resources.l10n", locale);
